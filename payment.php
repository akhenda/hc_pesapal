<?php
/* function for ajax payment through pesapal */

add_action('wp_ajax_listingpro_pesapal_pay', 'listingpro_pesapal_pay');
add_action('wp_ajax_nopriv_listingpro_pesapal_pay', 'listingpro_pesapal_pay');

if (!function_exists('listingpro_pesapal_pay')) {
	function listingpro_pesapal_pay() {
		...
		/* To make sure the try and thus the error runs only when the thankyou page is from PesaPal and not from another gateway */
